 ...
 * @author CLASSROOM01
 */
public class AllStateDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         // String state=(String)session.getAttribute("state");
          ...
          try
          {
            ...
            out.print("<html><body>");
            out.print("<h3>covid info of all state :</h3>");
            out.print("<table border=2>");
            out.print("<tr><td>sno</td><td>date</td><td>state</td><td>total</td><td>active</td><td>death</td></tr>");
            while(rs.next())
            {
